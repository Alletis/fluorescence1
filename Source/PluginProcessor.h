...
class FluorescenceAudioProcessor : public juce::AudioProcessor,
                                  private juce::AsyncUpdater
{
public:
    FluorescenceAudioProcessor();
    ~FluorescenceAudioProcessor() override;
...
private:
    ...
    void mapToDestination(int channel);
    ...
    using RawPeak = base_detection::RawPeak;
